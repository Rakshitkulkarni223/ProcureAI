  ...
  try {
    return (
      <div className="auth-shell h-[100dvh] overflow-y-auto bg-[#050816] p-3 sm:p-5 lg:p-6">
        ...
        <div className="relative flex min-h-0 items-center justify-center overflow-hidden bg-[radial-gradient(ellipse_at_84%_12%,rgba(45,212,191,0.14),transparent_32%),radial-gradient(ellipse_at_18%_90%,rgba(59,130,246,0.12),transparent_38%),linear-gradient(145deg,#0c1530,#070b1d)] px-4 py-6 sm:px-10 sm:py-10 xl:px-12">
          ...
          <div className="relative w-full max-w-lg rounded-[1.5rem] border border-white/10 bg-slate-950/25 p-6 shadow-[0_24px_60px_rgba(0,0,0,0.22)] backdrop-blur-xl sm:p-9 xl:max-w-md">{children}</div>
        </div>
      </div>
      </div>
    );
